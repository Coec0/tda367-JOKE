...
public class Bazooka extends Tower {
    ...
    private static String DESCRIPTION = "Less damage than a tank but higher rate of fire";
    ...
    public Projectile makeProjectile() {
        Projectile p = new BazookaMissile(super.getTarget().getPos(), super.getPos(), DAMAGE, SPEED);
